...
julia> view_reg3d(RI, MZ, title="NRMSE value", scale=3);

julia> view_reg3d(RI, SZ, title="NRMSE SD value", scale=3);
```
...
- `elev::Union{Real, Nothing}` : azimuthal viewing angle.
- `azim::Union{Real, Nothing}` : elevation viewing angle.
